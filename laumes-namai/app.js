...
function showHome() {
  location.hash = "";
  shell([
    '<header class="topbar"><span class="brand">Laumija</span><a class="home-link" href="https://laumija.lt/" aria-label="Grįžti į pagrindinį Laumijos puslapį">Į pagrindinį →</a></header>',
